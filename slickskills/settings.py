"""
Django settings for slickskills project.
...
WSGI_APPLICATION = 'slickskills.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'engineerjohnngigi@gmail.com'
EMAIL_HOST_PASSWORD = 'ceymbncfumkopqha'
